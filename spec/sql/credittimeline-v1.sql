...
-- ============================================================================
-- App-level tables (not part of the canonical credit data model)
-- ============================================================================

CREATE TABLE IF NOT EXISTS ingest_receipt (
  receipt_id TEXT PRIMARY KEY,
  file_id TEXT NOT NULL REFERENCES credit_file(file_id),
  import_id TEXT REFERENCES import_batch(import_id),
...
CREATE INDEX IF NOT EXISTS idx_ingest_receipt_sha256
  ON ingest_receipt(payload_sha256);

CREATE INDEX IF NOT EXISTS idx_audit_log_event_type
  ON audit_log(event_type, created_at DESC);

CREATE INDEX IF NOT EXISTS idx_insight_severity
  ON generated_insight(subject_id, severity, generated_at DESC);
